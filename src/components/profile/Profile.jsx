...
export default function Profile() {
  ...
  return (
    <div>
        ...
        <>
          <div className="pt-[50px] pb-[150px] max-w-[330px] mx-auto">
            ...
            <UserStats
              ...
              handleOpenPuzzlesModal={() => setIsPuzzlesModalOpen(true)}
            />
            <Link
              to={"/friends"}
              className="flex items-center justify-center gap-3 bg-[#D9D9D9] mb-6 rounded-md border-2 border-[#292139] py-1 text-xl font-bold tracking-wider"
            >
            ...
            <ProfileButtons
              handleStats={() => setIsStatsModalOpen(true)}
              handleLogout={() => setIsConfirmModalOpen(true)}
            />
            <div className="mt-5">
              <LanguageSwitcher />
            </div>
      ...
      {isPuzzlesModalOpen && (
        <PuzzlesModal onClose={() => setIsPuzzlesModalOpen(false)} />
      )}
      {isStatsModalOpen && (
