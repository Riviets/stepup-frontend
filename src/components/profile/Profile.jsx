...
export default function Profile() {
  ...
  const { data: userData, refetch: refetchUserData } = useFetch(authService.getCurrentUser);
  ...
  return (
    <div>
      ...
      {isEditModalOpen && <EditModal onClose={() => setIsEditModalOpen(false)} refetchUserData={refetchUserData} />}
      ...
      {isAchievementModalVisible && <AchievementsModal onClose={() => setIsAchievementModalVisible(false)} userData={userData} userCards={userCards} userPuzzles={userPuzzles} userPuzzleSets={userPuzzleSets}/> }
    </div>
  );
}