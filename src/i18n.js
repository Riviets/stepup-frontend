  ...
  ua: {
    translation: {
      ...
      levels: {
        ...
        setCompleted:
          ' Ви зібрали повний набір "{{setName}}" і отримали бонус +{{bonusValue}} XP за звичку!',
      ...
      addHabit: {
        ...
        errors: {
          ...
          currencyTooHigh:
            "Валюта не може бути більше 10 для користувацьких звичок",
      ...
      login: {
        ...
        errors: {
          ...
          invalidCredentials: "Неправильний email чи пароль!",
          authError: "Виникла помилка при авторизації",
        },
      },
      register: {
        title: "Зареєструватися",
        usernameLabel: "Введіть ім'я користувача:",
        emailLabel: "Введіть email:",
        passwordLabel: "Введіть пароль:",
        ...
        errors: {
          ...
          usernameTooShort: "Ім'я має містити мінімум 3 символи!",
          usernameTooLong: "Ім'я має містити максимум 16 символів!",
          ...
          authError: "Помилка при реєстрації. Спробуйте ще раз.",
        },
      },
    },
  },
  en: {
    translation: {
      ...
      levels: {
        ...
        setCompleted:
          ' You have collected the full set "{{setName}}" and received a bonus +{{bonusValue}} XP per habit!',
      ...
      register: {
        ...
        errors: {
          ...
          authError: "Error during registration. Please try again.",
        },
      },
    },
  },
